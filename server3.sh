...
# SNAPRAID
SNAPRAIDDEB="https://github.com/amadvance/snapraid/releases/download/v14.9/snapraid_14.9-1_amd64.deb"
SNAPRAIDDIR="/home/oggy/snapraid.deb"

wget "$SNAPRAIDDEB" -O "$SNAPRAIDDIR"
sudo dpkg -i "$SNAPRAIDDIR"
rm -rfv "$SNAPRAIDDIR"
