...
sudo apt update -y
sudo apt upgrade -y
sudo apt install cups gcc hplip make mc mergerfs samba transmission-daemon -y
...
echo 'UUID=3cd34620-4876-4f14-90cc-8260281baf4b /mnt/data2a1 auto nosuid,nodev,nofail 0 0' | sudo tee -a /etc/fstab
...
sudo chown oggy:oggy /mnt/data2a1
...
echo 'content /mnt/data2a1/snapraid.content' | sudo tee -a /etc/snapraid.conf
...
echo 'data data2 /mnt/data2a1/' | sudo tee -a /etc/snapraid.conf
